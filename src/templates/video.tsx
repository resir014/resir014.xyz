...
const VideoTemplate: React.SFC<VideoTemplateProps> = ({ data, location }) => {
  ...
  return (
    <PageWrapper
      pageTitle={`${post.frontmatter.title || 'Video posted by @resir014'} · ${siteMetadata.title}`}
    >
      <Helmet>
        <meta name="description" content={post.fields.lead || post.excerpt} />
        <meta name="author" content={siteMetadata.author.name} />
        <meta property="og:title" content={post.frontmatter.title || 'Video posted by @resir014'} />
