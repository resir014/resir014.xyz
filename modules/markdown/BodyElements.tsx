...
export const MarkdownParagraph: React.FC<WithStylesProps & ParagraphProps> = ({
  children,
  ...rest
...
export const UnorderedList: React.FC<WithStylesProps & TextProps> = ({ children, ...rest }) => (
  <Stack as="ul" css={UnorderedListStyles} spacing="sm" ml="md" mr="sm" p={0} {...rest}>
    {children}
  </Stack>
);

export const OrderedList: React.FC<WithStylesProps & TextProps> = ({ children, ...rest }) => (
  <Stack as="ol" css={OrderedListStyles} spacing="sm" ml="md" mr="sm" p={0} {...rest}>
    {children}
  </Stack>
);

export const ListItem: React.FC<WithStylesProps & TextProps> = ({ children, ...rest }) => (
...
export const CodeBlock: React.FC<WithStylesProps & BoxProps> = ({
  children,
  mt: _mt,
  mb: _mb,
  ...rest
