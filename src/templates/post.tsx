...
import { P, UL, LI } from '../components/markdown'
import { MessageBox } from '../components/chungking-core'
...
const PostTemplate: React.FC<PostTemplateProps> = ({ data, location }) => {
  ...
  return (
    <PageWrapper pageTitle={`${post.frontmatter.title} &middot; ${siteMetadata.title}`}>
      <Helmet>
